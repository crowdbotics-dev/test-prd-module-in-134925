"""
Django settings for test_prd_module_in_134925 project.
...
ROOT_URLCONF = 'test_prd_module_in_134925.urls'
...
WSGI_APPLICATION = 'test_prd_module_in_134925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_module_in_134925 API",
    "DESCRIPTION": "API documentation for test_prd_module_in_134925 App",
    "VERSION": "v1",
}
